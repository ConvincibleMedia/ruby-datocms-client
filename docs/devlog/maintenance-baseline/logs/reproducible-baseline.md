...
* The offline suite passed 155 examples with 93.63% line coverage.
* `dato-0.8.3.gem` built successfully and installed with 47 freshly resolved runtime gems under RubyGems 3.1.6.
