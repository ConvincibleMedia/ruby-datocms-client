...
* The first hosted CI run exposed a layout difference: Bundler cached dependencies under `vendor/bundle`, which RuboCop then scanned. The project configuration now excludes that dependency cache, and the subsequent hosted workflow passed.
